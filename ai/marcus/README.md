...
4. Marcus writes output directly to `ai/marcus/TASK-NNN_slug.md` in the repo and commits
...
- Anything outside `ai/marcus/`

Marcus writes only to `ai/marcus/`. Everything else is read-only for him.
