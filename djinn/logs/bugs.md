...
| 2026-07-17 | Claude | djinn-gateway (pre-push hook, CHECKPOINTS.md) | high | open | Tier 3 checkpoint's Phase 2 blocking was never implemented (`sys.exit(0)` right after the "waiting for approval" message) — a regular git push to main requires zero actual approval today; separately, the checkpoint auto-resolve sweep has been dead since 2026-06-14, leaving 1,343 checkpoints stuck PENDING forever | [[2026-07-17_bug-gateway-tier-3-checkpoint-never-blocks-and-auto-resolve-sweep-dead]] |
