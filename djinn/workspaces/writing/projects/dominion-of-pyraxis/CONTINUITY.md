...
# Continuity Bible — The Dominion of Pyraxis

> Single source of truth for all established facts. Before writing anything, check here first. If it's not here, establish it and add it.
...
Three parallel dating systems exist — different factions literally disagree on what year it is:

- **Pyraxis Reckoning (PR)** — Imperial standard, used in formal documents and by the noble houses
- **House Reckoning (HR)** — Individual noble houses track their own founding dates
- **Seasonal/lunar** — Used by common people

### Seasons & Months

| Season | Name | Meaning |
|--------|------|---------|
| Spring | Pyraxis | The empire's namesake season |
| Summer | Solentine | Also the name of the political House |
| Autumn | Valdross | |
| Winter | Mortain | |
...
- **Title:** Emperor Arctus — "first among equals, first to battle, first sacrifice for the empire"
- **Power:** Not absolute — he maneuvers around court while keeping family and marriage in line
- **Senate check:** Supermajority (7/9 Houses) can override his veto
- **Philosophy:** Moral disengagement — systematically uses family and subordinates as tools for absolution
- **Reign:** 15 years as of 1335 PR
- **15 years ago:** Devastating wars and failed imperial pregnancies hollowed out the imperial family

### The Lord High Steward (Brax)

Brax is **not** Prime Minister. He is the Lord High Steward — a Great Officer distinction:

- Manages the Imperial Household, court protocols, schedule, and access to the Emperor
- Controls the flow of documents, summons, audiences, and informal negotiations between ministers
- On paper: oversees palace, staff, ceremonies, the Emperor's personal estates
- In practice: everything passes through his hands — he pulls strings without holding a portfolio
...
Squad Leader → [standard ranks] → High Marshal

**Magical military:** Arcane Adjunct → [ranks] → High Arcanist

### Intelligence — The Fangs

Operatives → [chain] → Shadow Chancellor

The Shadow Chancellor answers primarily to the Emperor, outside normal bureaucratic accountability.

### Underworld — The Fists

Loose crews with specialist networks. No formal chain of command.
...
Magic is **will-based** — users shape reality through focused will. Individual signatures exist. No pure-blood requirement, but breeding creates variance in ability.
...
| Illusions | Reality distortion, sensory manipulation |
| Transformation | Altering appearance of self or objects |
| Mind influence | Subtle — Adept level required |
| Life/death boundary magic | Emperor's level — can prevent death, trap someone at the brink |

### Practitioner Classes

| Class | Level |
|-------|-------|
| Channeler | Entry level — developing ability |
| Adept | Skilled — can influence minds, complex casting |
| [Higher classes TBD] | |

**Show, don't explain.** Magic should be demonstrated through action with sensory tells, not exposition.
...
- Age: 21
- Sexuality: Bisexual
- In love with Javelin (his mentor, an older man)
- Engaged in arranged courtship with Lady Marcella Kalvennor
- Personality: Politically naive, impulsive, resentful of court expectations, emotionally volatile
- Inciting incident: Used magic at the imperial gala to transform his and Lady Marcella's attire mid-dance without her consent — breach of etiquette and bodily autonomy
- Magic ability: Will-based, functional but not subtle (publicly visible incident confirms this)
- Currently: Summoned to Emperor Arctus's office to face consequences
...
- Raxz's combat and magic mentor
- Raxz's lover
...
- Brilliant financial administrator
- Has an overactive magical core
- Self-medicates with alcohol
- Met secretly by Brax after the gala

### Lady Marcella Kalvennor

- Raxz's arranged courtship partner
- Magic was used on her without consent — her attire transformed mid-dance
- Participated in House Kalvennor's coordinated silent exit from the gala
- Character depth not yet fully established — needs development

### Princess Millie

- Imperial family member
- Was being held by Javelin after the gala
- Role in story not yet fully established
...
## Motifs & Symbols (use consistently)

| Motif | Meaning |
|-------|---------|
| Torches going out | Corruption moving forward, the cost of serving the Dominion, moving into darkness |
| Cages | Golden cages of privilege, literal imprisonment, metaphorical cages of duty — every character is in one |
...
## Open Questions (things not yet decided — do not invent answers)

- What happened 15 years ago exactly — the wars, the failed pregnancies, what actually collapsed
- Faust's true identity, goals, and power source
- Lady Marcella's interiority — does she want this marriage? What is her relationship to House Kalvennor's politics?
- Princess Millie's role
- Who burned Sec-tra in the prologue and why
- The full structure of the Shadow Council
- Corvus Shadowblade and Master Thorne's relationship to the Pyraxis timeline (may be a separate story/world — needs clarification from Javier)

---

## Notes on Corvus / Aethoria

The existing character files (Corvus Shadowblade, Master Thorne) and Aethoria world files appear to be from an earlier or parallel project. The magic system described there (Essence manipulation, Channeler/Adept classes) partially overlaps with Pyraxis but uses different terminology. **Clarify with Javier whether Aethoria = Coravian/Pyraxis or a separate project before integrating these files.**
