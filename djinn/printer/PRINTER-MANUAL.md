...
- Runs a dry-run slice to get real time and filament estimates (Creality Print CLI)
...
**What happens:** Djinn slices the model using your exact settings (Creality Print CLI). Takes 10–120 seconds depending on model size.
